...
const Sidebar = ({ expand, setExpand }) => {
  ...
  return (
    <div
      className={`flex flex-col justify-between bg-[#353232] pt-7 transition-all z-50 max-md:absolute max-md:h-screen ${
      ...
      <div>
        ...
        >
          ...
          <div
            ...
            className="group relative flex items-center justify-center hover:bg-gray-500/20 transtion-all duration-300 h-9 w-9 aspect-square rounded-lg cursor-pointer"
          >
        ...
        <button
          className={`mt-8 flex items-center justify-center cursor-pointer ${
            expand
              ? "bg-primary hover:opacity-90 rounded-2x1 gap-2 p-2.5 w-max"
        ...
        >
          <Image
            ...
            alt=""
          />
          <div className="absolute w-max -top-12 -right-12 opacity-0 group-hover:opacity-100 transition bg-black text -white text-white text-sm px-3 py-2 rounded-lg shadow-lg pointer-events-none">
            New chat
        ...
        >
          ...
          <div
            className={`absolute -top-60 pb-8 ${
              !expand && "-right-40"
            } opacity-0 group-hover: opacity-0 hidden group-hover: block transition`}
          >
            <div className="relative w-max bg-black text-white text-sm p-3 rounded-lg shadow-lg">
              <Image src={assets.qrcode} alt="" className="w-44" />
              <p>Scan to get Igris App</p>
              <div
                className={`w-3 h-3 absolute bg-black rotate-45 ${
